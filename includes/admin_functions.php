...
/**
 * Admin Logout Handler - Add this to your admin/index.php file
 * 
 * This function handles the logout process when the page parameter is "logout"
 * It should be called before the page routing switch in index.php
 */
...
// Call this function just before your page routing switch in index.php
// Example: if ($page === 'logout') { handleAdminLogout(); }