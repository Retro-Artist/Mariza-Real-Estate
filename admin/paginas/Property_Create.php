...
$property = [
    ...
    'status' => 'ativo',
    'quadra_lote' => '',
    'corretor_responsavel' => 0,
    'nome_anunciante' => '',
    'telefone_anunciante' => '',
    'palavras_chaves' => ''
];

// Get all categories, states for form selects
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Basic validation
    if (empty($_POST['titulo']) || empty($_POST['para']) || empty($_POST['id_categoria']) || empty($_POST['valor']) || empty($_POST['codigo'])) {
        ...
        if ($newPropertyId) {
            ...
            $error = 'Ocorreu um erro ao cadastrar o imóvel. Verifique se o código já não está sendo usado por outro imóvel.';
        }
    }
    ...
    if (!empty($error)) {
        ...
        if (!empty($_POST['id_estado'])) {
            $cities = getCitiesByState($_POST['id_estado']);
        }
        
        if (!empty($_POST['id_cidade'])) {
            $neighborhoods = getNeighborhoodsByCity($_POST['id_cidade']);
        }
    }
}
?>
...
<div class="admin-page property-create">
    ...
    <form method="POST" action="" class="admin-form" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group form-group--half">
                    ...
                    <input type="text" id="valor" name="valor" class="form-control" 
                           value="<?= $property['valor'] ? formatCurrency($property['valor']) : '' ?>" required>
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group form-group--full">
                    <label for="property_images">Adicionar Imagens</label>
